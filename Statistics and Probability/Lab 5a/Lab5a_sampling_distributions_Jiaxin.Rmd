---
title: "Foundations for statistical inference - Sampling distributions_5A"
author: "Jiaxin Zheng"
output: 
...
**Q1 Answer: The sample and full data set are roughly aligned.**
```{r}
...
**Q2 Answer: I don't expect the sample proportion to match the sample proportion of other student's. The sample proportion are independently random, other students may have somewhat different proportion.**
...
**Q3 Answer: The larger the sample size, the smaller the sampling error and accuracy becomes more precise.**
```{r}
...
**Q4 Answer: There are 1500 elements in sample_props50. The sampling distribution is the sample of the proportion of "Doesn't benefit" base on the random sampling. The plot looks like a normal distributed, and the center peaks around 0.2. **
...
**Q5 Answer: there are 22 rows in sample_props_small. Each observation represents a proportion sample of the population who doesn't believe in scientists.**
...
```{r}
num_elements <- nrow(sample_props_small)
num_elements
```
...
**Q6 Answer: When number of sample or number of simulations increase the mean of proportion is more precise. **
...
**Q7 Answer: Based on this calculation there is a 0.86 chance that the population believes scientist benefits the population.My best point estimates is 0.8. **
...
**Q8 Answer: Based on the sampling, the estimate is 0.8053.**
...
ggplot(data = sample_props15, aes(x = p_hat)) +
  ...
  labs(
    x = "p_hat (Benefits)",
    title = "Sampling distribution of population",
...
**Q9 Answer: Based on this sampling distribution, the estimate is 0.8014. When the sample is larger, the true proportion is more accurate, more closer to the center 80%.**
...
**Q10 Answer: If you're concerned with making estimates that are more often close to the true value, I would prefer a sampling distribution with a small spread. The core idea is the larger samples with smaller spread, that are more likely to be close to the true population proportion. **
